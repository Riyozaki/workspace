...
**Сейчас — подготовка перестройки второй арки.** Автор опасается затянутости и разрешил новую конструкцию глав. Сначала [конкретный замысел и вопросы](projects/shards-of-the-abyss/review/arc-02-rebuild-proposal.md), затем ответы и редактура. Выданная проза пока не меняется.
